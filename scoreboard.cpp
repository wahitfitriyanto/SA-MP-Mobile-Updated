...
void CScoreBoard::Draw()
{
    ...
    sprintf(szServerAddress, "%s | Pemain: %d", serverUTF8.c_str(), m_pPlayerCount);
    ...
    ImGui::Columns(4, "Papan Peringkat");

    ImGui::Text("ID"); ImGui::SetColumnWidth(-1, m_fScoreBoardSizeX / 100 * 10); ImGui::NextColumn();
    ImGui::Text("Nama"); ImGui::SetColumnWidth(-1, m_fScoreBoardSizeX / 100 * 60); ImGui::NextColumn();
    ImGui::Text("Level"); ImGui::SetColumnWidth(-1, m_fScoreBoardSizeX / 100 * 15); ImGui::NextColumn();
